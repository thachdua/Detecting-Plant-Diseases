...
1. Create or activate a Python 3.9–3.12 virtual environment. The dependency
   file pins TensorFlow conditionally: Python 3.9–3.11 installs 2.17.0 while
   Python 3.12 installs 2.20.0. TensorFlow chưa hỗ trợ Python 3.13, vì vậy hãy
   chắc chắn môi trường của bạn không vượt quá 3.12.
...
> `No matching distribution found for tensorflow==2.17.0`. Blueprint
> `render.yaml` trong repo cũng đã đặt sẵn Python 3.11 cho bạn.
